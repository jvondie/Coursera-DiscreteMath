# Write a Python function stableMatching(n, menPreferences,
# womenPreferences) that gets the number n of women and men,
# preferences of all women and men, and outputs a stable matching.
#
# The function should return a list of length n, where ith
# element is the number of woman chosen for the man number i.
